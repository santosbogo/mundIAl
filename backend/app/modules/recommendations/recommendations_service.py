...
async def get_recommendations(
    ...
    # Parse the ICS file to derive which hours the user is free.
    # The backend doesn't care whether the ICS was generated by the frontend
    # from manual slot selection or uploaded directly by the user.
    available_slots = ics_parser.parse_to_available_slots(profile.ics_content, profile.timezone)

    feature_matrix = feature_engineering.compute_batch(profile, matches, available_slots)
